...
def preprocess_input(data):
    ...
    df = pd.DataFrame([data], columns=[
        'gender', 'age', 'smoking_history', 'bmi', 'blood_glucose_level'
    ])
    return df
...
if __name__ == "__main__":
    while True:
        ...
        try:
            ...
            input_data[2] = int(input_data[2])  # smoking_history
            input_data[3] = float(input_data[3])  # bmi
            input_data[4] = float(input_data[4])  # blood_glucose_level
